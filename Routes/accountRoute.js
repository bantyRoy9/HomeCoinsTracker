...
router.route('/earn').get(getTotalEarns).post(protect,setUserAndGroupId('earnBy'),saveDailyEarnExpend('earn'),addUsersActivity).patch(protect,setUserAndGroupId('updatedBy'),updateDailyEarnExpend("earn"),addUsersActivity);
