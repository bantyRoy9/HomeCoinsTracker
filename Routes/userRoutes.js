...
const { createUser,verifyCreatedUserOTP, loginUser, protect, isLoggedIn, logout, restrictTo, resetPassword, forgotPassword, sendOTP, setFcmToken, removeFcmToken } = require('../Controllers/authController');
...
router.patch('/removefcmtoken/:token',removeFcmToken);
